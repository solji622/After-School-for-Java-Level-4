...
/*
wrapper class 생성 - 박싱(Boxing)
- 기본형을 래퍼 클래스로 변경하는 것을 마치 박스에 물건을 넣는 것 같다고 해서 박싱이라 한다
- new Integer(10)은 사용하면 안 된다. 현재까지 작동은 하지만, 향후 제거될 예정이다.
...
- 추가로 Integer.valueOf()에는 성능 최적화 기능이 있다.
    ...
    - 해당 범위의 값을 조회하면 미리 생성한 Integer 객체를 변환한다
